...
/*
    try...catch:异常处理的第二种方式,捕获异常，自己处理异常
    格式:
        try{
            可能产生异常的代码
    ...
    注意:
        ...
        2.如果try中产生了异常,那么就会执行catch中的异常处理逻辑,
                执行完毕catch中的处理逻辑,继续执行try...catch之后的代码
        ...
        try{
            ...
            /*
                java.io.IOException: 文件的后缀名不对
                    at ink_Exception.TryCatch06.readFile(TryCatch06.java:60)
	                at ink_Exception.TryCatch06.main(TryCatch06.java:27)
             */
